...
export const blogPosts: BlogPost[] = [
  {
    slug: "isletmeler-icin-ai-otomasyonu-nereden-baslanir",
  ...
  {
    slug: "whatsapp-business-api-nedir-nasil-kurulur",
  ...
  {
    slug: "restoranlar-icin-dijital-menu-donusumu",
  ...
  {
    slug: "kobiler-icin-ozel-yazilim-mi-hazir-yazilim-mi",
  ...
  {
    slug: "api-entegrasyonu-ile-manuel-veri-girisini-bitirmek",
  ...
  {
    slug: "kurumsal-web-sitesi-neden-hala-en-onemli-yatirim",
    title: "Sosyal Medya Çağında Kurumsal Web Sitesi Neden Hâlâ En Önemli Yatırım?",
    excerpt:
...
export function getRelatedPosts(slug: string, category: string, limit = 3): BlogPost[] {
  return blogPosts
    ...
    .concat(blogPosts.filter((post) => post.slug !== slug && post.category !== category))
    .slice(0, limit);
}
