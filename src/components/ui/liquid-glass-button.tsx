  ...
  return (
    <>
      ...
      >
        ...
        <div className="pointer-events-none z-10 inline-flex items-center gap-2">
          {children}
        </div>
        <GlassFilter />
      </Comp>
...
const metalButtonVariants = (
  ...
  const easing = "cubic-bezier(0.1, 0.4, 0.2, 1)";
  ...
  return {
    ...
    wrapperStyle: {
      ...
      transition: `transform 250ms ${easing}, box-shadow 250ms ${easing}`,
    ...
    buttonStyle: {
      ...
      transition: `transform 250ms ${easing}, filter 250ms ${easing}`,
      transformOrigin: "center center",
      filter:
